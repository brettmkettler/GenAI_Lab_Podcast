...
def main():
    ...
    with tab1:
        ...
        st.subheader("Upload Newsletter Document")
    ...
    with tab2:
        ...
        # ElevenLabs API Key with default key from environment variable
        #st.session_state.api_key = st.text_input("ElevenLabs API Key", type="password")
